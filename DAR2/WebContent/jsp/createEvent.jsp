...
<script type="text/javascript" src="/DAR2/assets/js/searchevent.js" charset="UTF-8"></script>
<!-- <script type="text/javascript" src="/DAR2/assets/js/searchuniversity.js"></script>
 --><!-- Fin  Scripts  -->
...
<link rel="stylesheet" href="/DAR2/assets/css/modal.css">
...
<body>
    ...
    <ul class="breadcrumb">
        ...
        <li class="active"><a href="/DAR2/events?mode=create">évenements > création</a></li>
				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						...
						<form id="eventForm" method="post" class="form-horizontal"
							action="/DAR2/events?mode=create">
