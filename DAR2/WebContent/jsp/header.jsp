...
<div class="container-fluid">
	...
	<div class="container-fluid="navbar-header">
		...
		<a class="navbar-brand" href="/DAR2/home">UNI-Connect</a>
	</div>
	<div id="navbar" class="navbar-collapse collapse">
		<ul class="nav navbar-nav">

			<li class="dropdown "><a href="/DAR2/events?mode=actus&limit=15">Actus</span></a>
             ...
             <li><a href="/DAR2/events?mode=new">Créer  </a></li>
			
				<li><a href="/DAR2/jsp/eventSearch.jsp">Rechercher 
							</a></li>
...
<!-- 
					...
					<li class=" dropdown"><a href="#"
						...
						<ul class="dropdown-menu">
							<li><a href="/DAR2/jsp/profil.jsp">Tableau de bord</a></li>
							<!-- <li><a href="#">Mes Paramètres</a></li> -->
							<li><a href="/DAR2/logout">Déconnexion</a></li>
						</ul></li>
				...
				<c:otherwise>
					...
					<li class=" "><a href="/DAR2/signin">Connexion </span></a>
					<li class=""><a href="/DAR2/signup">Inscription</a></li>
				</c:otherwise>
			</c:choose>
