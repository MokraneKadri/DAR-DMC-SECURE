        ...
        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xs-offset-0 col-sm-offset-0 col-md-offset-3 col-lg-offset-3 toppad" >
          ...
          <div class="panel panel-info">
            ...
            <div class="panel-body">
              <div class="row">
                <div class="col-md-3 col-lg-3 " align="center"> <img alt="User Pic" src="/DAR2/assets/img/avatar.gif" class="img-circle img-responsive"> </div>
                ...
                <div class=" col-md-9 col-lg-9 "> 
                 ...
                 <div class="panel-footer">
                        ...
                        <span class="pull-right">
                            <a href='/DAR2/profil?user=<c:out value="${login}"/>' data-original-title="Edit this user" data-toggle="tooltip" type="button" class="btn btn-sm btn-warning"><i class="glyphicon glyphicon-edit"></i></a>
