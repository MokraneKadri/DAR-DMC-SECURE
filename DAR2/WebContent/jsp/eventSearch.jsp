			...
			.done( function (data) {
				...
				$.each(result, function (i, event) {
					...
					'<div class="panel-body">'+
		           			'<div class="media">'+
		              	    '<a class="pull-left" href="/DAR2/events?mode=event&id='+ event.id + '">'+	
		              	  		
		              	    		'<h4 class="media-heading">'+ event.name+'</h4>'+
		              	         	'<p>créer par : '+ event.creator +'</p>'+
		              	         	
		              	         	'<p class="text-right"><a href="/DAR2/events?mode=event&id='+event.id+'" class="btn btn-info"> Details >> </a>'+ '</p>'+
		              	         	...
		              	         	'<ul class="list-inline list-unstyled">'+
		              	            	...
		              	            	'<li>|</li>'+
		              	            	'<span><i class="glyphicon glyphicon-comment"></i> ' + event.comments + ' <a href="/DAR2/events?mode=event&id='+ event.id +'#com">commentaires<a/></span>'+
