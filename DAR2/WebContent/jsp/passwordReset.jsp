...
<meta name="viewport" content="width=device-width, initial-scale=1">
   ...
   <!-- style du footer  -->
   <link rel="stylesheet" href="http://localhost:8080/DAR2/assets/css/pageFooter.css">
   <!-- style du header  -->
   <link rel="stylesheet" href="http://localhost:8080/DAR2/assets/css/header.css">
   <!--  content style -->
   <link rel="stylesheet" href="http://localhost:8080/DAR2/assets/css/main.css">
   	<!-- Fin Styles  -->	
...
<body>
    ...
    <ul class="breadcrumb">
        ...
        <li class="active"><a href="/DAR2/passwordreset">Réeinitialisation du mot de passe </a></li>
				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<form id="signinform" method="post" class="form-horizontal" action="/DAR2/passwordreset">
