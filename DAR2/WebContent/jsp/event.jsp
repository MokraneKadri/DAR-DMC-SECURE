...
<%@page import="fr.upmc.dar2.entities.User"%>
<%@page import="fr.upmc.dar2.entities.Comment"%>
<%@page import="fr.upmc.dar2.enums.EventVisibility"%>
<%@page import="fr.upmc.dar2.dao.interfaces.IEventDao"%>
    ...
    <head>
        ...
        <script>
            var redirect = settimeout(() => {
                window.location.href = "/DAR2/events?mode=actus&limit=15"			
            }, 3000); 
        ...
        <link rel="stylesheet" href="/DAR2/assets/css/notifier.css">
    ...
    <body>
        ...
        <div class="maincontainer" id="maincontainer">
            ...
            <div class='well' id="com">
                ...
                <form action='/DAR2/events' method='POST'>
                    <input  name='mode' 
                            type='hidden' 
                            value='comment' /> 
                    <input  name='id' 
