...
import fr.upmc.dar2.dao.ApiDAO;
import fr.upmc.dar2.dao.DAOFactory;
import fr.upmc.dar2.dao.EventDao;
...
import fr.upmc.dar2.entities.University;
import fr.upmc.dar2.entities.User;
import fr.upmc.dar2.enums.EventVisibility;
import fr.upmc.dar2.enums.UriMapping;
import fr.upmc.dar2.json.Error;
import fr.upmc.dar2.json.Success;
import fr.upmc.dar2.json.Warning;
...
public class EventsServlet extends HttpServlet {
			...
			IOException 
	{
		...
		break;
		case "showall":response.sendRedirect("/DAR2/events?mode=list&type=jsp");//request.getRequestDispatcher(UriMapping.EVENTSLIST.getRessourceUrl()).forward(request, response);
		break;
		case "event":
	 ...
	 * Requête : /DAR2/events?mode=event&id=<em>x</em> <br/>
	 * 
	 * @param request
	 * @param response
	 ...
	 * 
	 * Soit <em> x </em> un entier naturel > 0 <br/> 
	 * Requête : /DAR2/events?mode=actus&limit=<em>x</em> <br/>
	 * 
	 * @param request
	 * @param response
	 * @throws ServletException
	 ...
	 * 
	 * Soit <em> x </em> un entier naturel > 0 <br/> 
	 * Requête : /DAR2/events?mode=list[&id=<em>x</em>]<br/>
	 * 
	 * @param request
	 * @param response
	 * @throws ServletException
	 ...
	 * Requête : /DAR2/events?mode=search[&name=#][&privacy=#][&description=#][&date=#][&theme=#][&places=#][&address=#]
	 * 
	...
	/**
	 * Request : /DAR2/events?mode=create&name=#&privacy=#&description=#&date=#&theme=#&places=#&address=#&place_type=#&place_name=#[&business_id=#]
	 * 
	 * @param request
	 * @param response
	 * @throws ServletException
	...
	/**
	 *  Request : /DAR2/events?mode=remove&id=#
	 * 
	 * @param request
	 * @param response
	 * @throws ServletException
	...
	/**
	 *  Request : /DAR2/events?mode=update&id=#[&name=#&privacy=#&description=#&date=#&theme=#&places=#&address=#]
	 * @param request
	 * @param response
	 * @throws ServletException
	 * @throws IOException
	...
	/**
	 * Request : /DAR2/events?mode=comment&id=#&content=#
	 * 
	 * @param request
	 * @param response
	 * @throws ServletException
